...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Delete Categoria'), ['action' => 'delete', $categorium->nome], ['confirm' => __('Você realmente deseja excluir o Categoria registrado com o CNPJ {0}?', $categorium->cnpj), 'class' => 'side-nav-item', 'onmouseover' => "this.style.color='#d33c43'", 'onmouseout' => "this.style.color='#606c76'"]) ?>
